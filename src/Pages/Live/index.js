...
const Live = ({
  ...
  const cloudRecord = async (user, agoraStreamId) => {
    agoraStartRecordRequest({userId: 999, channelName: "nissi", resourceId: agoraStreamId, mode: "mix"});
  };
  ...
  useEffect(() => {
    if (!agoraToken && user) {
      ...
      agoraStreamResourceRequest({userId: 999, channelName: 'nissi'});
